...
public class HomeView extends VerticalLayout {
    ...
    public HomeView() {
        ...
        Paragraph content3 = new Paragraph(new H4("This website is also subject to change as seen fit by the " +
                "instructor of this class."));


        //create image for home page
        Image laptop = new Image("/images/laptop-5673901_1280.jpg", "Laptop");
        laptop.setSizeFull();

        //add content to view
        add(welcomeText, laptop, content1, content2, content3);
